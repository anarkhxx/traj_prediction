...
import random
import copy
import distance_cells.compute_distance as help
...
class Model():
    ...
    def _init_train(self):
        ...
        with self.train_graph.as_default():
            ...
            self.train_target_seq_new_weight=tf.placeholder(tf.float32, shape=[self.batch_size,None,len(self.train_vocabs)])
            ...
            self.loss = seq2seq.seq_loss(output, self.train_target_seq_new_weight,
    ...
    #Prediction model_ init_ Eval and_ init_ Infer is basically the same
    def _init_eval(self):
    ...
    #Init_ Train and_ init_ After the graph of Eval is finished, the method is called

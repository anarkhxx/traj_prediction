...
class NeighborhoodGen():
		...
		while len(walk) < walk_length:
			...
			try:
				...
				if len(cur_nbrs) > 0:
					...
					#Because all three graphs have no neighbors, they are dead loops..
					#print("There are no neighbors. We have to change")
					return walk
					continue
	...
	def preprocess_thread(self, layer, counter):
		...
		#This part is to recalculate the weight of that side and the node
